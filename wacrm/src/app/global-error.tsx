...
// plain — no dependency on globals.css/fonts/theme provider/next-intl,
// since those are exactly the kind of thing that could be the cause.
      ...
      <body style={{ display: 'flex', minHeight: '100dvh', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '1rem', fontFamily: 'system-ui, sans-serif', padding: '1.5rem', textAlign: 'center' }}>
        <div>
          ...
          <p style={{ marginTop: '0.25rem', maxWidth: '24rem', fontSize: '0.875rem', color: '#666' }}>
            The app ran into a problem loading this page. Try again, and if it keeps happening, let the team know.
          </p>
        </div>
        <button
          type="button"
