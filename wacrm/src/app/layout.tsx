...
export const metadata: Metadata = {
  title: {
    default: "Kiranam Comm Center",
    template: "%s — Kiranam",
  },
  description: "Kiranam's WhatsApp comm center — inbox, broadcasts, and templates for contributors and volunteers.",
  robots: {
    index: false,
    follow: false,
  },
  // No explicit `icons` entry — `src/app/icon.png` is picked up
  // automatically by Next.js's file-based metadata convention.
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
