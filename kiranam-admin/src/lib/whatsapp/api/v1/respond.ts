...
//
// Every `/api/whatsapp/v1/*` route speaks one shape so external integrators
...
// used by the dashboard's own `/api/whatsapp/*` routes — the public contract
// is versioned and shouldn't inherit internal wording changes.
// ============================================================

import { NextResponse } from 'next/server';
import type { RateLimitResult } from '@/lib/whatsapp/rate-limit';
