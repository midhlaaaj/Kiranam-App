...
//
// Calling convention — every `/api/whatsapp/v1` route does:
//
//   try {
...
import { findActiveKeyByHash, touchLastUsed } from '@/lib/whatsapp/api-keys/store';
import { hashApiKey, looksLikeApiKey } from '@/lib/whatsapp/api-keys/keys';
import { hasScope, type ApiScope } from '@/lib/whatsapp/api-keys/scopes';
import { forbidden, rateLimited, unauthorized } from '@/lib/whatsapp/api/v1/respond';
import { checkRateLimit, RATE_LIMITS } from '@/lib/whatsapp/rate-limit';
