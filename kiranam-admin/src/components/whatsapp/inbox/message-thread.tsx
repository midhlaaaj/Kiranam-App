...
import { PresenceDot } from "@/components/whatsapp/presence/presence-dot";
import { presenceLabel } from "@/lib/whatsapp/presence";
...
import { deleteAccountMedia } from "@/lib/whatsapp/storage/upload-media";
...
const DOODLE_BG_CLASSES =
  "bg-background bg-[url('/whatsapp/inbox-doodle.svg')] bg-repeat";
...
export function MessageThread({
  ...
  const postReaction = useCallback(
    async (messageId: string, emoji: string) => {
      ...
      try {
        const res = await fetch("/api/whatsapp/whatsapp/react", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
