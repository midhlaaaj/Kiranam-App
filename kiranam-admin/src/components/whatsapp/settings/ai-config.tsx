...
import type { AiProvider } from '@/lib/whatsapp/ai/types';
import type { AccountMember } from '@/types/whatsapp';
import { fetchAccountMembers, memberLabel } from '@/lib/whatsapp/account/members';
...
export function AiConfig() {
  ...
  const handleRemove = async () => {
    setRemoving(true);
    try {
      const res = await fetch('/api/whatsapp/ai/config', { method: 'DELETE' });
      if (res.ok) {
