...
import type { WhatsAppConfig as WhatsAppConfigType } from '@/types/whatsapp';
...
export function WhatsAppConfig() {
  ...
  const fetchConfig = useCallback(async (acctId: string) => {
    ...
    try {
      ...
      if (data) {
        try {
          const res = await fetch('/api/whatsapp/whatsapp/config', { method: 'GET' });
  ...
  async function handleVerifyRegistration() {
    ...
    setRegistrationProbe(null);
    try {
      const res = await fetch('/api/whatsapp/whatsapp/config/verify-registration', {
        method: 'GET',
      });
