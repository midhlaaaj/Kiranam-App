// Landed on after confirming an email-address change from kiranam-app
// (updateEmail in AppContext.tsx). Unlike password-reset/signup, this one
// isn't a mobile deep link — the app picks up the new confirmed address
// on its own next foreground via sync_confirmed_email(), so this page only
// needs to say "you're done, you can close this."
