...
vi.mock('@/lib/whatsapp/auth/account', () => ({
...
vi.mock('@/lib/whatsapp/contacts/tag-events', () => ({
  addContactTagAndDispatch: mocks.add,
}));

vi.mock('@/lib/whatsapp/contacts/tag-write', () => ({
...
describe('/api/whatsapp/contacts/[id]/tags', () => {
