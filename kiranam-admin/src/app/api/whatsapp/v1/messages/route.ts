...
// `/api/whatsapp/whatsapp/send` (which takes an internal `conversation_id`),
...
import { requireApiKey } from '@/lib/whatsapp/auth/api-context';
import { ok, fail, toApiErrorResponse } from '@/lib/whatsapp/api/v1/respond';
import { resolveConversationByPhone } from '@/lib/whatsapp/whatsapp/resolve-conversation';
import {
  sendMessageToConversation,
  validateSendMessageParams,
  SendMessageError,
} from '@/lib/whatsapp/whatsapp/send-message';
import type { InteractiveMessagePayload } from '@/lib/whatsapp/whatsapp/interactive';
