...
import { decrypt, encrypt, isLegacyFormat } from '@/lib/whatsapp/whatsapp/encryption'
import { getMediaUrl, downloadMedia } from '@/lib/whatsapp/whatsapp/meta-api'
import { normalizePhone } from '@/lib/whatsapp/whatsapp/phone-utils'
import { findExistingContact, isUniqueViolation } from '@/lib/whatsapp/contacts/dedupe'
import { verifyMetaWebhookSignature } from '@/lib/whatsapp/whatsapp/webhook-signature'
import { runAutomationsForTrigger } from '@/lib/whatsapp/automations/engine'
import { dispatchInboundToFlows } from '@/lib/whatsapp/flows/engine'
import { dispatchInboundToAiReply } from '@/lib/whatsapp/ai/auto-reply'
import { dispatchWebhookEvent } from '@/lib/whatsapp/webhooks/deliver'
import {
  handleTemplateWebhookChange,
  isTemplateWebhookField,
} from '@/lib/whatsapp/whatsapp/template-webhook'
...
async function parseMessageContent(
  ...
  const verifyAndBuildUrl = async (
    ...
    try {
      ...
      return `/api/whatsapp/whatsapp/media/${mediaId}`
    } catch (error) {
      console.error(
