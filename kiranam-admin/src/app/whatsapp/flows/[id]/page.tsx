...
import { FlowEditorShell } from "@/components/whatsapp/flows/flow-editor-shell";
import type { FlowRow, FlowNodeRow } from "@/lib/whatsapp/flows/types";

/**
 * Flow editor shell.
 *
 * Loads `{flow, nodes}` from `/api/whatsapp/flows/[id]` and hands it to
